...
public class EmbeddingUtil {
    ...
    private static final String API_KEY = "sk-937378dfe8f04fc0925976e87638038f"; // 您的API_KEY
    private static final String EMBEDDING_API_URL = "https://dashscope.aliyuncs.com/compatible-mode/v1/embeddings";
